    ...
    <Layout canGoBack>
      <div className="px-4 py-4">
        <div className="mb-8">
          ...
          <div className="mt-5">
            <h1 className="text-3xl font-bold text-gray-900">Galaxy 550</h1>
            <span className="text-2xl block mt-3 text-gray-900">$140</span>
            <p className="my-6 text-gray-700">
              My money&apos;s in that office, right? If she start giving me some
              bullshit about it ain&apos;t there, and we got to go someplace
              there. Then I&apos;m gonna shoot that bitch in the kneecaps, find
              out where my goddamn money is. She's gonna tell me too. Hey, look
              at me when I&apos;m talking to you, motherfucker. You listen: we
              go in there, and that ni**a Winston or anybody else is in there,
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            {[1, 2, 3, 4, 5, 6].map((_, i) => (
              <div key={i}>
                ...
                <h3 className="text-gray-700 -mb-1">Galaxy 560</h3>
