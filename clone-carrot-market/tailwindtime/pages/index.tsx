  ...
  return (
    <div className="bg-fuchsia-100 w-auto min-h-screen mx-auto font-sans">
      ...
      <div className="grid xs:grid-cols-1 lg:grid-cols-3 gap-1 mx-16 min-h-screen py-20 place-items-center">
        {/* 첫번째 div */}
        <div className="bg-white w-5/6 h-full px-5 pt-10 md:mr-0 lg:-mr-32">
        ...
        {/* 두번째 div */}
        <div className="bg-white w-5/6 h-full px-5">
          ...
          <div className="my-10 grid sm:grid-cols-1 lg:grid-cols-2 xs:grid-rows-4 lg:grid-rows-2 gap-4 place-items-center">
            <div className="border-black border-solid border-2 w-44 h-48 rounded-xl bg-yellow-400 lg:place-self-end">
              <div className="px-14 py-16">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </div>
            </div>
            <div className="border-black border-solid border-2 w-44 h-48 rounded-xl bg-teal-400 lg:place-self-start">
              <div className="px-14 py-16">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
            ...
            <div className="border-black border-solid border-2 w-44 h-48 rounded-xl bg-pink-400 lg:place-self-end">
              <div className="px-14 py-16">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
            ...
            <div className="border-black border-solid border-2 w-44 h-48 rounded-xl bg-red-400 lg:place-self-start">
              <div className="px-14 py-16">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-14 w-14 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
        ...
        {/* 세번째 div */}
        <div className="bg-yellow-400 w-5/6 h-full px-5 md:mr-0 lg:mr-32">
          ...
          <div className="grid xs:grid-rows-6 gap-3 my-4">
            <div className="relative">
              ...
              className="w-8 h-8 absolute right-0 -mt-12 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="bg-white border-black border-solid border-2 rounded-xl w-full h-22 p-6">
              <div className="grid gap-2 sm:grid-cols-1 xl:grid-cols-5 xs:grid-rows-3 xl:grid-rows-1 place-items-center">
                ...
                <div className="xs:place-self-center xl:place-self-start xl:col-span-3 pt-0 justify-self-start">
                  ...
                  <p className="font-montserrat font-semibold">Planet Designer</p>
                </div>
                <div className="xl:place-self-end">
                  <button className="bg-yellow-400 w-20 h-12 rounded-xl border-black border-solid border-2 border-b-4 text-md font-extrabold">Invite</button>
                </div>
              </div>
            </div>
            <div className="bg-white border-black border-solid border-2 rounded-xl w-full h-22 p-6">
            ...
            <div className="bg-white border-black border-solid border-2 rounded-xl w-full h-22 p-6">
              <div className="grid gap-2 sm:grid-cols-1 xl:grid-cols-5 xs:grid-rows-3 xl:grid-rows-1 place-items-center">
                ...
                <div className="xl:place-self-end">
                  <button className="bg-black w-20 text-white h-12 rounded-xl border-black border-solid border-2 border-b-4 text-md font-extrabold">Invited</button>
                </div>
              </div>
            </div>
            <div className="bg-white border-black border-solid border-2 rounded-xl w-full h-22 p-6">
