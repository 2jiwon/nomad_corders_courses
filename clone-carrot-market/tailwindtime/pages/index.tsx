  ...
  return (
    <div className="bg-fuchsia-100 min-w-fit min-h-screen mx-auto font-sans">
      ...
      <div className="grid xs:grid-cols-1 lg:grid-cols-3 gap-1 mx-16 min-h-screen py-20 place-items-center">
        {/* 첫번째 div */}
        <div className="bg-white w-4/5 h-full px-5 pt-10 md:mr-0 lg:-mr-32">
        ...
        {/* 세번째 div */}
        <div className="bg-yellow-400 w-4/5 h-full px-5 md:mr-0 lg:mr-32">
          ...
          <div className="grid xs:grid-rows-6 gap-2">
            ...
            <div className="bg-white border-black border-solid border-2 rounded-xl w-full h-22 p-6">
              <div className="grid gap-2 sm:grid-cols-1 xl:grid-cols-5 xs:grid-rows-3 xl:grid-rows-1 place-items-center">
                ...
                <div className="xl:place-self-end">
                  <button className="bg-yellow-400 w-24 h-12 rounded-xl border-black border-solid border-2 border-b-4 text-xl font-extrabold">Invite</button>
                </div>
              </div>
            </div>
            <div className="bg-white border-black border-solid border-2 rounded-xl w-full h-22 p-6">
            ...
            <div className="bg-white border-black border-solid border-2 rounded-xl w-full h-22 p-6">
              <div className="grid gap-2 sm:grid-cols-1 xl:grid-cols-5 xs:grid-rows-3 xl:grid-rows-1 place-items-center">
                ...
                <div className="xl:place-self-end">
                  <button className="bg-black w-24 text-white h-12 rounded-xl border-black border-solid border-2 border-b-4 text-xl font-extrabold">Invited</button>
                </div>
              </div>
            </div>
            <div className="bg-white border-black border-solid border-2 rounded-xl w-full h-22 p-6">
